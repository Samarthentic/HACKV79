...
const Hero = () => {
  return (
    <section id="hero" className="relative bg-gradient-to-br from-talentsleuth to-talentsleuth-dark text-white">
      <div className="container mx-auto py-20 md:py-32 px-6 md:px-12 lg:px-24 flex flex-col items-center text-center">
